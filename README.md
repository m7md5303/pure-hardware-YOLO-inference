...
<p> This how the system should look like for simulation. It is also possible if you want to integrate it in your project your use it only in a hadware project. Just take care of the IO mapping to generate your bitstream properly</p>
